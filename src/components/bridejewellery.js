...
export default function EqualSpaceMasonryLayout() {
  return (
    <div className="masonry-container">
      ...
      <div className="description-section">
        ...
        <img className="bottom-image mt-4" src="https://i.pinimg.com/736x/da/e0/af/dae0afe558fc29c1759dfecae1cef049.jpg" alt="Explore more" />
      </div>
